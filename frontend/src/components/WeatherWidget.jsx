...
import { CloudRain, Sun, Cloud, Wind, Droplets, Eye, Thermometer, RefreshCw } from 'lucide-react';
      ...
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[2rem] p-6 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-2">
            {forecast.map((day, i) => (
              <div key={i} className="flex-1 bg-white/10 rounded-2xl p-2 text-center">
